...
try:
    ...
    print("Conversation inserted:", conversation_id)
    ...
    result = (
        db.query(Message).filter(Message.conversation_id == conversation_id).first()
    )
    ...
    print_section("DECISION INSERT TEST")
