...
class XAIEngine:
    ...
    def _summary(
        ...
        summaries = {
            ...
            "Mild Concern":
                (
                    "The system detected mild concern "
                    "signals."
                ),
            ...
            "Safe":
                (
                    "No significant safety risk indicators "
                    "were detected."
                )
    ...
    def _reasoning_chain(
        ...
        rules = {
            ...
            "critical_crisis":
                "Critical crisis indicator increased emergency priority",


            "crisis_signal":
                "Crisis language increased safety risk",
            ...
            "history_increase":
                "Previous risk history increased concern",


            "context_risk_high":
                "High contextual safety risk detected"
    ...
    def generate(
        ...
        signal_analysis = self._explain_signals(
...
ExplainabilityEngine = XAIEngine
