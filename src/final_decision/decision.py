...
class FinalDecisionEngine:
    ...
    def _calculate_final_score(
        ...
        context_score = context_fusion.get(
    ...
    def _generate_reasons(
        ...
        if base_risk.get(
            ...
            reasons.append(
                "High individual message risk detected"
            )
        ...
        if memory.get(
            ...
            reasons.append(
                "Risk increased across conversation history"
            )
    ...
    def _recommended_action(
        ...
        if level == "High Risk":
            ...
            return (
                "Priority safety monitoring required"
            )
        ...
        return (
            "No immediate safety action required"
        )
    ...
    def decide(
        ...
        final_level = self._detect_level(
